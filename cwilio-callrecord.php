...
if(array_key_exists("RecordingSource",$_REQUEST))
{
    ...
    $postfieldspre = array("internalAnalysisFlag" => "True", "text" => "A call recording has been received in regards to this ticket. It has been attached to the documents section of this ticket."); //Post ticket as API user
