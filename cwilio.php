...
if($nightmode == 1 && ($currentdate < strtotime($startday) || $currentdate > strtotime($endday)))
{
    if(array_key_exists('Digits',$_REQUEST))
    {
        ...
        else
        {
            ...
            echo "<Say>Invalid entry, please select from the following options. Press 1 to leave a message in our after hours support queue, you will receive a call back within 15 minutes.</Say>\n";
            echo "</Gather>\n";
        }
    }
    else
    {
        echo "<Gather numDigits='1' action='cwilio.php' method='POST'>\n";
        echo "<Say>Thank you for calling $ivrname, you've reached our after hours support line. $afterhourswarning. Press 1 to leave a message in our after hours support queue, you will receive a call back within 15 minutes.</Say>\n";
        echo "<Pause length='3' />\n";
        echo "<Say>Thank you for calling $ivrname, you've reached our after hours support line. $afterhourswarning. Press 1 to leave a message in our after hours support queue, you will receive a call back within 15 minutes.</Say>\n";
        echo "<Pause length='5' />\n";
        echo "</Gather>\n";
